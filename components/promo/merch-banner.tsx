    ...
    <div className="group relative flex w-full flex-col items-center justify-center overflow-hidden rounded-2xl bg-primary p-8 text-center shadow-lg transition-transform hover:-translate-y-1">
      ...
      <div className="relative z-10 flex flex-col items-center gap-3">
        ...
        <Link
          href="/merch"
        >
          <button className="cursor-pointer mt-4 rounded-sm bg-background px-8 py-3 font-display text-sm font-bold uppercase tracking-widest text-foreground transition-colors hover:bg-muted">
            Shop Now
          </button>
        </Link>
      </div>
